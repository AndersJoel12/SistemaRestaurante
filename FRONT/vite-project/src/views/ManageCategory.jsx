      ...
      <div className="p-4 md:p-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            name="btn-new-category" // Identificador para tests
            className="w-full sm:w-auto bg-red-700 hover:bg-red-800 text-white font-bold py-3 px-6 rounded-lg shadow-md disabled:opacity-50 transition-transform active:scale-95 text-base flex items-center justify-center gap-2"
          >
