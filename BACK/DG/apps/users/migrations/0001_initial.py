    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', models.IntegerField(blank=True, null=True, verbose_name='Cédula')),
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('mesero', 'Mesero'), ('cocinero', 'Cocinero')], default='mesero', max_length=20, verbose_name='Rol')),
